...
class Modal2 extends React.Component{
  ...
  */
  axios.post("https://mike.sollazzo.tk/api/sign_s3",{
    fileName : fileName,
    fileType : fileType
  })
  .then(response => {
    ...
    */
    axios.post("https://mike.sollazzo.tk/api/image", {                      
      url : url
  ...
  render(){
    ...
    return(
      ...
      <div className="modal fade bg-dark" id="UpdateProfilePicture" tableindex="-1" role="dialog" aria-hidden="true">
